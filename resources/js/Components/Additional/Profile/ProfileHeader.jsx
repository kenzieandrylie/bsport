                    ...
                    <div className="flex flex-col items-center sm:flex-row p-2 basis-full">
                        ...
                        <div className="flex items-center basis-1/4 justify-center">
                            ...
                            :
                                ...
                                :
                                    <button type="submit" className="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 lg:w-3/4" onClick={handleFollow} disabled={disable}>Follow</button>
                            }
                        </div>
                    </div>
                </div>
